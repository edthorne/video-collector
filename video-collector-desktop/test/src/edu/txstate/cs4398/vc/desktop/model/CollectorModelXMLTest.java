 ...
 * @author Ed
 */
public class CollectorModelXMLTest {
	// test data
	...
	public void setUp() throws Exception {
		xmlFile = File.createTempFile("CollectorModelXMLTest", ".cvd");
	...
	public void testJAXBMarshalling() throws Exception {
		...
		CollectorModel fModel = (CollectorModel) unmarshaller
				.unmarshal(xmlFile);

		// verify transient defaults
		assertFalse(fModel.isDirty());
		assertNull(fModel.getFile());

		verifyCollection(fModel.getCollection());
	}
